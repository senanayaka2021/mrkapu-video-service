...
const actor_auth_service_1 = require("./actor-auth.service");
...
exports.SharedAuthModule = SharedAuthModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [actor_auth_service_1.ActorAuthService],
        exports: [jwt_1.JwtModule, actor_auth_service_1.ActorAuthService],
    })
], SharedAuthModule);
export {};
